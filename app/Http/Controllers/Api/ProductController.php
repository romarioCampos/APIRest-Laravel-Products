...
class ProductController extends Controller
{
    ...
    public function show($id)
    {
        ...
        if(! $product) return response()->json(ApiError::errorMessage('Produto nao encontrado!', 4040), 404);
    ...
    public function delete(Product $id)
    {
        try{
            ...
            return response()->json(ApiError::errorMessage('Houve um erro ao realizar a operacao de remover', 1012), 500);
        }
    }
}
